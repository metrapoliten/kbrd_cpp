image:https://github.com/metrapoliten/kbrd_cpp/actions/workflows/build.yml/badge.svg[Build + test, link="https://github.com/metrapoliten/kbrd_cpp/actions/workflows/build.yml"]
image:https://github.com/metrapoliten/kbrd_cpp/actions/workflows/static_analysis.yml/badge.svg[clang-format, link="https://github.com/metrapoliten/kbrd_cpp/actions/workflows/static_analysis.yml"]
